  ...
  describe('POST /api/users', function () {
    ...
    it('Should reject users with missing username', function () {
      return chai
        ...
        .then(res => {
          ...
          expect(res.body.message).to.equal('fields: \'username\' can not be empty');
        });
    });
    ...
    it('Should reject users with missing password', function () {
      return chai
        ...
        .then(res => {
          expect(res).to.have.status(422);
          expect(res.body.message).to.equal('fields: \'password\' can not be empty');
        });
    });
    ...
    it('Should reject users with non-trimmed username', function () {
      return chai
        ...
        .then(res => {
          expect(res).to.have.status(422);
          expect(res.body.message).to.equal('field: \'username\' can not have leading or trailing white spaces');
        });
    });
    ...
    it('Should reject users with non-trimmed password', function () {
      return chai
        ...
        .then(res => {
          expect(res).to.have.status(422);
          expect(res.body.message).to.equal('field: \'password\' can not have leading or trailing white spaces');
        });
    });
    ...
    it('Should reject users with empty username', function () {
      return chai
        ...
        .then(res => {
          expect(res).to.have.status(422);
          expect(res.body.message).to.equal('field: \'username\' must be at least 2 characters long');
        });
    });
    ...
    it('Should reject users with password less than 8 characters', function () {
      return chai
        ...
        .then(res => {
          expect(res).to.have.status(422);
          expect(res.body.message).to.equal('password must be between 8 and 72 characters long');
        });
    });
